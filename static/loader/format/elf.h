...
#define ELFSTRUCTURES    class TELF_Header, class TELF_SectionHeader, \
  class TELF_Symbol, class TELF_Relocation
#define ELFSTRUCTURES_INS TELF_Header, TELF_SectionHeader, \
  TELF_Symbol, TELF_Relocation
