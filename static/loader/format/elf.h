...
#define SHT_RELA                                                               \
    4 // Relocation entries with addends. Warning: Works only in 64 bit mode in
      // my tests!
...
#define SHT_REMOVE_ME                                                          \
    0xffffff99 // Specific to objconv program: Removed debug or exception
               // handler section
...
#define STT_GNU_IFUNC                                                          \
    10                // Symbol is an indirect code object (function dispatcher)
...
#define R_386_PC32                                                             \
    2 // Self-relative 32 bit (not EIP relative in the sense used in COFF files)
...
#define R_386_IRELATIVE                                                        \
    42 // Reference to PLT entry of indirect function (STT_GNU_IFUNC)
...
#define R_X86_64_PC32                                                          \
    2 // Self relative 32 bit signed (not RIP relative in the sense used in COFF
      // files)
...
#define R_X86_64_IRELATIVE                                                     \
    37 // Reference to PLT entry of indirect function (STT_GNU_IFUNC)
...
// list
#define ELFSTRUCTURES                                                          \
    class TELF_Header, class TELF_SectionHeader, class TELF_Symbol,            \
        class TELF_Relocation
#define ELFSTRUCTURES_INS                                                      \
    TELF_Header, TELF_SectionHeader, TELF_Symbol, TELF_Relocation
...
/*
extern SIntTxt ELFFileClassNames[];
extern SIntTxt ELFDataEncodeNames[];
extern SIntTxt ELFABINames[];
extern SIntTxt ELFFileTypeNames[];
extern SIntTxt ELFSectionTypeNames[];
extern SIntTxt ELFSectionFlagNames[];
extern SIntTxt ELFSymbolBindingNames[];
extern SIntTxt ELFSymbolTypeNames[];
extern SIntTxt ELF32RelocationNames[];
extern SIntTxt ELF64RelocationNames[];
extern SIntTxt ELFMachineNames[];
*/
#endif // #ifndef ELF_H
