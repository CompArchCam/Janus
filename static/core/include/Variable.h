...
struct VarState : Variable {
    ...
    /** \brief Opposite of pred, contains the varstates that immediately use
     * this varstate in their definitions
     */
     ...
     * *Loop::isConstant(VarState\*)*, which determines whether this variable is
     * constant in the given loop.
     *
