...
class RewriteRule
{
  public:
    ...
    RewriteRule(){};
    RewriteRule(RuleOp op, PCAddress blockAddr, PCAddress ruleAddr,
                uint32_t instrId);
...
void insertRule(uint32_t channel, janus::RewriteRule rule,
                janus::BasicBlock *block);
void replaceRule(uint32_t channel, janus::RewriteRule rule,
                 janus::BasicBlock *block);

void removeRule(uint32_t channel, janus::RewriteRule rule,
                janus::BasicBlock *block);
