...
class MachineInstruction
{
  public:
    ...
    /** \brief returns whether this is a partial MOV instruction: X[32:127] =
     * X[32:127]; X[0:31] = Y */
    bool isMOV_partial();
    ...
    bool isNEG();
    /** \brief returns whether this is a push instruction decreasing the stack
     * pointer */
    bool isPUSH();
    /** \brief returns whether this is a pop instruction increasing the stack
     * pointer */
    bool isPOP();
    /** \brief returns whether this is an example of using LEA for
     * addition/subtraction to the given variable.
     *
     *  Returns true iff this is a LEA instruction in which the given variable
     * appears without scaling, ie the result is the given variable with a
     * factor of 1 plus/minus some other variable and/or numeric constant.
     */
    ...
    bool isTypeChange();
    /** \brief returns positive if the instruction is a shift right instruction,
     * the shift right immediate value */
    int isShiftRight();
    int isShiftLeft();
